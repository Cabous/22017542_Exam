...
For this question I put my fund’s performance into perspective by comparing it to the benchmark (Capped SWIX) as well as some industry peers (ASISA active managers).
